Ext.define("Myapp.view.fooViewport", {
    extend: 'Ext.container.Viewport',
    alias: 'widget.viewport',

    requires: [
        'Ext.panel.Panel',
        'Myapp.view.fooViewportController',
        'Myapp.view.fooViewportModel',
        'Myapp.store.MyStore'
    ],
    ...
    initComponent: function() {
        ...
        this.viewModel = Ext.create("Myapp.view.fooViewportModel", { data: 1});
